...
def get(system_id: str):
    ...
    def _fn(params, profiles, pv_size, run_checks: bool = False):
        ...
        # Nur 1D-Zeitreihen als "expected" erweitern;
        # ev_discharged ist typischerweise 2D (t x N_EV) und bleibt deshalb optional.
        for opt_key in ("hp_electricity", "pv_to_load_direct"):
        ...
        df = _hourly_table(
            ...
            generation_keys=[k for k in spec["generation"] if (k in res and k in expected)],
