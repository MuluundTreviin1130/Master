...
def main() -> None:
    ...
    ap.add_argument("--ecoinvent_db", default="ecoinvent 3.11 cutoff")
    ap.add_argument("--ecospold_dir", required=True)
    ...
    # Repair invalid biosphere references (based on debug/step44 approach)
