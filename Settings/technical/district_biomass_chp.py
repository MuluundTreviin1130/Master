...
@dataclass
class DistrictBiomassCHPConfig:
    """Technical SSOT for a district-heating biomass CHP unit."""
...
def make_district_biomass_chp() -> DistrictBiomassCHPConfig:
    return DistrictBiomassCHPConfig()
