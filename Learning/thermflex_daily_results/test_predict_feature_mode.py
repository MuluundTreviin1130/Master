...
if importlib.util.find_spec("pandas") is None:
    ...
    @unittest.skip("pandas is required for thermflex_daily_results.predict")
    class PredictFeatureModeTest(unittest.TestCase):
        def test_predict_feature_mode_requires_pandas(self) -> None:
            self.fail("unreachable while skipped")
