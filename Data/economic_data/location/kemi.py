...
LOCATION_ECONOMICS = {
    ...
    "grid": {
        "buy_eur_per_kwh": 0.32,
        "feed_eur_per_kwh": 0.09,
    },
    "community": {
        "buy_eur_per_kwh": 0.31,
        "feed_eur_per_kwh": 0.09,
    },
    "technology": {
        "pv": {"capex_eur_per_kwp": 1300.0, "maintenance_rate": 0.01},
        "bess": {"capex_eur_per_kwh": 580.0, "maintenance_rate": 0.01},
        "ev": {
        ...
        "small_wind": {"capex_eur_per_kw": 3400.0, "maintenance_rate": 0.03},
        "large_wind": {"capex_eur_per_kw": 1750.0, "maintenance_rate": 0.025},
        "biogas_engine": {"capex_eur_per_kw": 2450.0, "maintenance_rate": 0.05},
        "wood_gasifier": {
            "capex_eur_per_kw": 2150.0,
            "maintenance_rate": 0.045,
            "fuel_eur_per_kwh_fuel": 0.043,
        },
