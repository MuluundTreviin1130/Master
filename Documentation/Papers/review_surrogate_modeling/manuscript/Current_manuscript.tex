...
\begin{figure*}[!t]
\centering
\includegraphics[width=\textwidth]{./doc/keywords.png}
\caption{Keywords}
\label{fig1}
\end{figure*}
...
\centering
\scriptsize
\begin{tabularx}{\textwidth}{@{}L{0.16\textwidth} C{0.05\textwidth} C{0.08\textwidth} L{0.21\textwidth} L{0.20\textwidth} L{0.22@\textwidth} Family & Output & Opt.Â compat. &@{}}
\toprule
...
MÃ¼hlpfordt et al.Â~\cite{Muhlpfordt20194806} introduced the
...
models. DÃ­az-ManrÃ­quez et al.Â~\cite{DiazManriquez2016} focus on surrogate-assisted MOO
...
fitness replacement and evolution control. FernÃ¡ndez-Godino \cite{FernandezGodino2023} reviews
...
MancÃ² et al.Â~\cite{Manco2024} provide a review of MES optimization and discuss how LP,
...
calibration. VelÃ¡squez et al.Â~\cite{velasquez_intelligence_2023} use an
...
and societal damages. PÃ©rez-Uresti et al.Â~\cite{Pérez-Uresti2023} use a NN
