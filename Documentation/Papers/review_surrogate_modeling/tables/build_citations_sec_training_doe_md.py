"""Emit markdown table: Key | DOI | Title | Venue for 05_training_data_doe.tex cites.

Run from repo anywhere:

    py -3 Documentation/Papers/review_surrogate_modeling/tables/build_citations_sec_training_doe_md.py

Writes: tables/citations_sec_training_doe_key_doi_title_venue.md
"""
...
TEX = ROOT / "manuscript" / "05_training_data_doe.tex"
BIB = ROOT / "references" / "review_mes_moo_surrogates.bib"
OUT = Path(__file__).resolve().parent / "citations_sec_training_doe_key_doi_title_venue.md"
...
def main() -> None:
    ...
    lines = [
        "# Training data and DOE section — citations (overview)",
        "",
        "Generated from `manuscript/05_training_data_doe.tex` → "
